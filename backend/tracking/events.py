...
def _named_worker_init():
    ...
    setproctitle.setproctitle("DynamiX-Labs - SatellitePassWorker")

    # Set multiprocessing process name
    multiprocessing.current_process().name = "DynamiX-Labs - SatellitePassWorker"
...
def run_events_calculation(
    ...
    if current_proc.name.startswith("ForkPoolWorker"):
        setproctitle.setproctitle("DynamiX-Labs - SatellitePassWorker")
        current_proc.name = "DynamiX-Labs - SatellitePassWorker"
