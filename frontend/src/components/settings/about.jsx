                    ...
                    <Grid container spacing={2} columns={12} alignItems="center">
                        <Grid size={{ xs: 12, md: 8 }}>
                            <Stack direction="row" spacing={2} alignItems="center">
                                <img src="/dynamix_labs_logo.png" alt="DynamiX-Labs Logo" style={{ height: '56px', width: 'auto' }} />
                                <Box>
                                    <Typography variant="h4" sx={{ fontWeight: 700 }}>
                                        DynamiX-Labs Ground Station
                                    </Typography>
                        ...
                        <Grid size={{ xs: 12, md: 4 }}>
                            <Stack direction={{ xs: 'column', sm: 'row', md: 'column' }} spacing={1} alignItems={{ xs: 'stretch', md: 'flex-end' }}>
                                <Button
                                    ...
                                    aria-label={t('about.repo_link_aria', { defaultValue: 'Open DynamiX-Labs Ground Station GitHub repository in a new tab' })}
                                    underline="none"
                                >
